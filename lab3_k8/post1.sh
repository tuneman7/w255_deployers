curl -X POST -H 'Content-Type: application/json' localhost:8000/ -d '{"MedInc":2.125,"HouseAge":50.0,"AveRooms":4.242424242424242,"AveBedrms":1.071969696969697,"Population":697.0,"AveOccup":2.640151515151515,"Latitude":37.85,"Longitude":-122.26 }'
