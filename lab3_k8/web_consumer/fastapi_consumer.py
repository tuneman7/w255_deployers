...
@fastapi_consumer.route('/fastapi_consumer', methods=['POST', 'GET'])
def fastapi_consumer():
...
@fastapi_consumer.route('/section_five_pred', methods=['POST', 'GET'])
...
import locale
@fastapi_consumer.route('/get_county_dataset', methods=['POST', 'GET'])
...
@fastapi_consumer.route('/get_county_json', methods=['POST', 'GET'])
def get_county_json():
...
@fastapi_consumer.route('/test_jqgrid', methods=['POST', 'GET'])
def test_jqgrid():
        ...
        #http://localhost:5023/test_jqgrid?county_name=los_angeles_ca
